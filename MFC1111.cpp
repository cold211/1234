...
// MFC1111.cpp: определяет поведение классов для приложения.
//
...
// Объявляем функцию NtQuerySystemInformation
...
BEGIN_MESSAGE_MAP(CMFC1111App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFC1111App

CMFC1111App::CMFC1111App()
{
...
// Единственный объект CMFC1111App

CMFC1111App theApp;


// Инициализация CMFC1111App

BOOL CMFC1111App::InitInstance()
{
